...
var BurstBullet = NormalBullet.extend({
    ...
    destroy: function() {
            if (global.sound) {
            cc.AudioManager.sharedEngine().playEffect(s_explodeSound);
        }
        ...
        try {
            ...
            spark(this.getPosition(),this.getParent(), 1.2, 0.5);
        } catch (ex) {
...
var BurstBullet2 = BurstBullet.extend({
    ...
    blink: function() {
         ...
         if (global.sound) {
            cc.AudioManager.sharedEngine().playEffect(s_timerSound);
        }
    },
    setOff: function() {
        this.schedule(this.blink, 0.1);
        this.schedule(this.destroy, 0.65);
    },
});
